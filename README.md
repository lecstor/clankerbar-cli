...
the phase's `max_turns` wins, then this, then a built-in default of 300
...
longer means uncapped; it means "defer upward".
...
It is deliberately always on — it is a detector, not a budget.
